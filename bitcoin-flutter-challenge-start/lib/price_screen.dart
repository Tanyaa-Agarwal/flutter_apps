...
class _PriceScreenState extends State<PriceScreen> {
  ...
  void getData() async {
    try {
      ...
      var data1 = await CoinData().getCoinData(selectedCurrency,"BTC");
      var data2 = await CoinData().getCoinData(selectedCurrency,"ETH");
      var data3 = await CoinData().getCoinData(selectedCurrency,"LTC");
      setState(() {
        btcValue = data1.toString();
        ethValue=data2.toString();
        ltcValue=data3.toString();
      });
    } catch (e) {
      print(e);
    }
